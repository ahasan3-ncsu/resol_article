...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.32\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/coordSystem.pdf}
	\end{subfigure}
	\caption{
...
so that all fission tracks point in the same direction.
...
To that end, 5 FF BCA simulations are analyzed to assess recoil behavior.
...
Therefore, recoils generated by FFs
more than $\delta = 100$ nm away from a bubble
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=8cm]{images/recoil1.png}
	\caption{
...
Thus, there exists a finite annular region just outside the bubble surface
...
from a FF-bubble simulation (details please).
...
\begin{subfigure}{0.49\textwidth}
	\centering
	\caption{}
	\includegraphics[width=7cm]{images/xe_dr.pdf}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
	\centering
	\caption{}
	\includegraphics[width=7cm]{images/xe_hist.pdf}
\end{subfigure}
\caption{
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[width=7cm]{images/chi_2nm_Y.pdf}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[width=7cm]{images/chi_2nm_I.pdf}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[width=7cm]{images/chi_64nm_Y.pdf}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[width=7cm]{images/chi_64nm_I.pdf}
	\end{subfigure}
	\caption{
...
Surface mesh \ref{fig:surf_mesh}
