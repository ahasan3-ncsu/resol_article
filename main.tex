...
\begin{subfigure}{0.65\textwidth}
	\centering
	\caption{}
	\includegraphics[height=5cm]{images/rotation.pdf}
\end{subfigure}
\begin{subfigure}{0.34\textwidth}
	\centering
	\caption{}
	\includegraphics[height=5cm]{images/a.pdf}
\end{subfigure}
\caption{
	asdf
}
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[height=5cm]{images/b.pdf}
	\end{subfigure}
	\caption{
		(a) FF tracks.
		(b) Surface discretization of FF information.
	}
	\label{fig:fftrack}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=6cm]{images/c.pdf}
	\caption{
		Surface meshing
	}
	\label{fig:surf_mesh}
