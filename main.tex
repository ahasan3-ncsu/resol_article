...
\begin{abstract}
	...
	FFs of different energies and Xe gas bubbles in U-10Mo are assessed.
...
a spherical material inside a distinct cuboid one.
...
% FIX: should we include it or not?
% To verify our assumption, we computed the thermal conductivity of U-10Mo
% through non-equilibrium MD simulations,
% showing reasonable accuracy compared to experiments.
...
is just shy by $20$ keV/nm for both FFs.
As expected, % FIX: wrong use of Bragg peak?
the nuclear stopping power has a characteristic Bragg peak \cite{brown2004}
towards the end of FF trajectory.
...
representing electronic stopping power ranging from $20$ keV/nm to $30$ keV/nm.
...
Ion simulations were performed in steps of $1,000$ at a time,
...
due to the interaction of the bubble with a FF that originated at $(D, \ell')$
...
as defined by the ion probability profiles
