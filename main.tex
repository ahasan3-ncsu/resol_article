...
after absorption. Under irradiation, the Xe atoms in the gas bubble are thrown
back into the fuel matrix by fission product-induced cascades and thermal
spikes (re-solution of Xe), and this process reduces the bubble size
\cite{ye2023}.
...
The re-solution rate is used in the mesoscale program DART \cite{ye2023}. The
currently used re-solution model in the program is described below.
\begin{align}
...
on atom and thermal spike methods, respectively.
