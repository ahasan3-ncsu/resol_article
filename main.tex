...
\begin{abstract}
	...
	Electronic thermal spikes in U-10Mo
	are then emulated by utilizing the two-temperature model (TTM) with MD.
	It is found that
	electronic thermal spikes cannot cause re-solution in U-10Mo.
	...
	an overall Xe gas bubble re-solution rate $b_{hom}$ is computed.
	$b_{hom}/\dot{F}$
