...
\begin{abstract}
	...
	bubbles in $\gamma$U-10Mo fuel. Primary knock-on atom (PKA) simulations
	were employed to account for low-energy interactions ($\leq 500$ keV).
	High-energy interactions were emulated using the thermal spike method with
	a linear energy deposition between 5 keV/nm and 30 keV/nm. Re-solution from
	the low-energy interactions is found to be negligible compared to the
	high-energy ones. In the thermal spike simulations, Xe gas bubbles of
	varying radii and pressure were considered. The thermal spike axis was also
...
UO$_2$. In 2012, Govers et al. \cite{govers2012} performed PKA and thermal
spike simulations of Xe gas bubbles in UO$_2$ and proposed a mathematical model
for the re-solution rate. However, the most comprehensive work on Xe gas bubble
re-solution in UO$_2$ was conducted  in 2018 by Setyawan et al.
...
\cite{matthews2015}, using binary collision methods. The thermal spike
model was not employed in UC because it was assumed that the local heating does
not exceed the melting temperature \cite{matthews2015, ronchi1986}. In
...
\cite{stoller2000}. Moreover, collision cascades end up in heat spikes due to
nuclear stopping. In that regard, the simulation of PKAs also encompasses the
heterogeneous re-solution. To identify atoms that are re-solved ballistically,
a threshold atomic speed, above which it is improbable to find atoms in thermal
equilibrium, can be utilized \cite{parfitt2008}. For MD simulations of
heterogeneous re-solution due to swift heavy ions, the thermal spike model is
normally employed. This model is useful for describing the interaction between
the fission fragments and the fuel. These interactions occur primarily via
...
heterogeneous re-solution mechanisms by simulating PKAs and thermal spikes. We
also calculated the electronic stopping power of representative fission
products so as to determine the energy imparted on gas bubbles by fission
events at a certain distance. Finally, we evaluated an overall re-solution rate
of Xe gas bubbles as a function of bubble radius, bubble pressure, and fission
rate.
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=6cm]{oldimg/struct.png}
	\caption{
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[height=6cm]{oldimg/temp_time.pdf}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[height=6cm]{oldimg/resol_time.pdf}
	\end{subfigure}
	\caption{
...
range of the PKAs (up to 500 keV). This holds even though the re-solution from
PKA simulations can be a combination of both homogeneous and heterogeneous
re-solution.

The homogeneous re-solution is expected to be a few orders of magnitude smaller
than the heterogeneous re-solution, as the collision cross section of a PKA is
substantially smaller than the interaction cross section between a bubble and a
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/pka1.png}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/pka2.png}
	\end{subfigure}

	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/pka3.png}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/pka4.png}
	\end{subfigure}
	\caption{
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/spike1.png}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/spike2.png}
	\end{subfigure}

	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/spike3.png}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\caption{}
		\includegraphics[width=\textwidth]{oldimg/spike4.png}
	\end{subfigure}
	\caption{
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.69\textwidth}
		\centering
		\caption{}
		\includegraphics[height=6cm]{oldimg/resolutionVsRadius.pdf}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\caption{}
		\includegraphics[height=6cm]{oldimg/saturationFactor.pdf}
	\end{subfigure}
	\caption{
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=7cm]{oldimg/offcentered.pdf}
	\caption{
...
not seem to depend on either bubble pressure or size for sufficiently large
bubbles. Only the thermal spike energy seems to have a relationship with the
number of re-solved atoms, as is also apparent in Figure \ref{fig:frac}(a). One
possible explanation for this behavior is that thermal spikes create
low-density regions around the Xe gas bubble, and these regions facilitate the
...
atoms that can remain in a low-energy configuration outside the original
bubble.
...
\begin{figure}[ht]
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[height=6cm]{oldimg/xevac.pdf}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\caption{}
		\includegraphics[height=6cm]{oldimg/r2dep.pdf}
	\end{subfigure}
	\caption{
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=7cm]{oldimg/coordSystem.pdf}
	\caption{
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=7cm]{oldimg/elec_stopping.pdf}
	\caption{
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=7cm]{oldimg/resRate.pdf}
	\caption{
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=7cm]{oldimg/3d.pdf}
	\caption{
		Xe gas bubble re-solution rate in $\gamma$U-10Mo as a function of
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=7cm]{oldimg/resRate_withDart.pdf}
	\caption{
...
re-solution mechanisms were investigated using PKA and thermal spike
simulations. However, homogeneous re-solution was found negligible in
